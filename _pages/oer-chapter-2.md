---
layout: page
title: 'Open Culture in #ASKnet: Access, Collaboration, and Shared Knowledge'
...
{% include image.html src="/assets/img/oer/chapter-2/image3.jpg" caption="#ROSHOP Regional Construction Site #ASKtraining" %}
...
* #ROSHOP [#ASKtraining Module](https://training.asknet.community/modules/ROSHOP/%20) 
* #ROSHOP [GitHub Construction](https://github.com/WeAreYEF/ROSHOP/blob/main/Step-by-Step-Procedure.md) step by step   
* #ROSHOP [Video](https://www.youtube.com/watch?v=37qcm1aUtps%20) Presentation
...
{% include image.html src="/assets/img/oer/chapter-2/image2.jpg" caption="#ASKnet media communications training" %}
...
{% include image.html src="/assets/img/oer/chapter-2/image1.jpg" caption="#ASKnet Open Source Documentation GUIDE (ODG)" %}
...
#ASKtraining Platform
> link to the  external platform
The  platform is an open, adaptable, and community-driven space designed to compile, share, and streamline workshops, OER and “how-to” guides.

#ASKnet Open Learning Guide
> link to OLG on our website
Is a rugged poster with lists of resources to Open Educational Resources around the topics of online literacy, technology and DIY communities.

#ASKnet Open Hardware Guide
> link to OHG on our website
The guide gives examples of hands-on skills, possibilities and projects applying open hardware methodologies for trainers, tinkerers and facilitators.

#ASKnet Open Source Documentation Guide
> link to ODG on our website
