...
<div class="row shuffle-wrapper">
  <div class="col-md-4 col-sm-6 mb-4 shuffle-item">
    <div class="position-relative hover-wrapper"> 
      <img src="{{ site.baseurl }}/assets/img/oer/chapter-1/chapter1-thumbnail.jpg" alt="chapter-1" class="img-fluid w-100 d-block" style="height: 200px"> 
      <a class="hover-overlay" href="{{ site.baseurl }}/oer/chapter-1"> </a>
    </div><a href="{{ site.baseurl }}/oer/chapter-1">
      <div class="caption">
        <h4>Chapter 1: Open Culture - From Knowledge to Action</h4>
      </div>
    </a>
  </div>
  <div class="col-md-4 col-sm-6 mb-4 shuffle-item">
    <div class="position-relative hover-wrapper"> 
      <img src="{{ site.baseurl }}/assets/img/oer/chapter-2/chapter2-thumbnail.jpg" alt="chapter-2" class="img-fluid w-100 d-block" style="height: 200px"> 
      <a class="hover-overlay" href="{{ site.baseurl }}/oer/chapter-2"> </a>
    </div><a href="{{ site.baseurl }}/oer/chapter-2">
      <div class="caption">
        <h4>Chapter 2: Open Culture in #ASKnet - Access, Collaboration, and Shared Knowledge</h4>
      </div>
    </a>
  </div>
  <div class="col-md-4 col-sm-6 mb-4 shuffle-item">
    <div class="position-relative hover-wrapper"> 
      <img src="{{ site.baseurl }}/assets/img/oer/chapter-3/chapter3-thumbnail.jpg" alt="chapter-2" class="img-fluid w-100 d-block" style="height: 200px"> 
      <a class="hover-overlay" href="{{ site.baseurl }}/oer/chapter-3"> </a>
    </div><a href="{{ site.baseurl }}/oer/chapter-3">
      <div class="caption">
        <h4>Chapter 3: Imagine the Future of OER</h4>
      </div>
    </a>
  </div>
</div>
