---
layout: page
title: Open Knowledge and Open Educational Resources
permalink: /oer
---
...
<figure class="text-center">
  <img src="{{ '/assets/img/oer/01-repair-cafe.jpg' | relative_url }}" class="img-fluid rounded" alt="climateresilience">
...
Dive right in or continue on this page with the introduction
...
<div class="row shuffle-wrapper">
  <div class="col-md-4 col-sm-6 mb-4 shuffle-item">
    <div class="position-relative hover-wrapper"> 
      ...
      <a class="hover-overlay" href="{{ site.baseurl }}/oer/chapter-1"> </a>
    </div><a href="{{ site.baseurl }}/oer/chapter-1">
      <div class="caption">
        <h4>Chapter 1</h4>
  ...
  <div class="col-md-4 col-sm-6 mb-4 shuffle-item">
    <div class="position-relative hover-wrapper"> 
      ...
      <a class="hover-overlay" href="{{ site.baseurl }}/oer/chapter-2"> </a>
    </div><a href="{{ site.baseurl }}/oer/chapter-2">
      <div class="caption">
        <h4>Chapter 2</h4>
        <p class="text-muted">topic</p>
      </div>
  ...
  <div class="col-md-4 col-sm-6 mb-4 shuffle-item">
    <div class="position-relative hover-wrapper"> 
      <img src="{{ site.baseurl }}/assets/img/resources/solar-charger.jpg" alt="chapter-2" class="img-fluid w-100 d-block"> 
      <a class="hover-overlay" href="{{ site.baseurl }}/oer/chapter-3"> </a>
    </div><a href="{{ site.baseurl }}/oer/chapter-3">
      <div class="caption">
        <h4>Chapter 3</h4>
        <p class="text-muted">topic</p>
      </div>
...
> “If ‘knowledge’ is power, ‘open knowledge’ is empowerment…” <br> <br>
> — Dr. Rufus Pollock <br>
> [https://rufuspollock.com/](https://rufuspollock.com/) 

<figure class="text-center">
  <img src="{{ '/assets/img/oer/02-solar-charger.jpg' | relative_url }}" class="img-fluid rounded" alt="climateresilience">
  <figcaption class="mt-2 text-muted">
...
* The UNESCO 2019 OER Recommendation, which many countries are beginning to embed into policy. ([UNESCO](https://www.unesco.org/en/open-educational-resources))  
...
An example of open learning can be seen in the story of [George Mel](https://andariya.com/post/Aircrafts-and-Drones-can-lead-Innovation-for-a-better-South-Sudan),  the passionate self taught aeroplane engineer from South Sudan who realised his dream of learning to fly.   
...
<figure class="text-center">
  <img src="{{ '/assets/img/oer/03-george-mel-plane.jpg' | relative_url }}" class="img-fluid rounded" alt="climateresilience">
  <figcaption class="mt-2 text-muted">
...
<figure class="text-center">
  <img src="{{ '/assets/img/oer/04-open-hardware-guide.jpg' | relative_url }}" class="img-fluid rounded" alt="climateresilience">
  <figcaption class="mt-2 text-muted">
